...
DEFAULT_EPOCH=315532800  # 1980-01-01T00:00:00Z, matching deterministic ZIP epoch.
...
def build_sbom(archive,output,epoch):
    ...
    document_name=archive.name+'.spdx'
    namespace=f'https://github.com/xuan2261/RF-Network-Tool/releases/v1.4.2/sbom/{archive.name}/{archive_sha256}'
    package={
    ...
    document={
        ...
        'creationInfo':{
            ...
            'creators':['Tool: RF-Network-Tool deterministic SBOM generator v1.4.2'],
...
def main():
    ...
    for archive in args.archives:
        ...
        output=archive.with_suffix('.spdx.json')
        print(build_sbom(archive,output,args.source_date_epoch))
