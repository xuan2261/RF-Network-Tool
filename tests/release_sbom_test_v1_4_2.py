...
out=root.parent
archives=[
    out/'RF-Network-Tool-v1.4.2-FULL-QA-CI-E2E-PROJECT.zip',
    out/'RF-Network-Tool-v1.4.2-FULL-QA-CI-E2E-PORTABLE.zip',
]
...
def expected_verification_code(sha1_values):
