...
checks={
 ...
 'orchestrator_core_gates':all(x in ps for x in ['WINDOWS_INTEGRATION_TEST_v1_4_2.ps1','WINDOWS_IPV6_NDP_READINESS_v1_4_2.ps1','WINDOWS_LINT_GATE_v1_4_2.ps1','WINDOWS_CHAOS_TEST_v1_4_2.ps1','WINDOWS_PERFORMANCE_TEST_v1_4_2.ps1','WINDOWS_LAUNCHER_E2E_v1_4_2.ps1']),
 ...
 'ipv6_ndp_readiness_gate':'ipv6_ndp_readiness' in ps and 'WINDOWS_IPV6_NDP_READINESS_v1_4_2.ps1' in ps and 'IPv6/NDP read-only readiness' in ci,
