...
checks={
 ...
 'windows_v142_tests_in_full':all((root/x).is_file() for x in ['tests/WINDOWS_INTEGRATION_TEST_v1_4_2.ps1','tests/WINDOWS_LINT_GATE_v1_4_2.ps1','tests/WINDOWS_LAUNCHER_E2E_v1_4_2.ps1','tests/WINDOWS_SMOKE_TEST_v1_4_2.md']),
