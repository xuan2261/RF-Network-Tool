...
runtime=[
 ...
 'release_tools/build_release_v1_4_2.py','release_tools/build_sbom_v1_4_2.py','tests/release_sbom_test_v1_4_2.py',
 '.github/actionlint.yaml','.github/workflows/ci.yml','.github/workflows/ui-e2e-selfhosted.yml'
]
secret_patterns={
