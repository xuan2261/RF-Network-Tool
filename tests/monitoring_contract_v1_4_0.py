...
checks={
 ...
 'disable_freezes_clock':'Set-MonitorEnabledState' in main and '$stat.AccountingMono=$null' in main,
 'worker_failure_freezes_clock':'A worker failure is not a network outage' in main and 'Set-MonitorMeasurementError' in main,
