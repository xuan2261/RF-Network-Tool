...
files=[
 ...
 'runtime_integrity_contract_v1_4_2.py','ci_workflow_contract_v1_4_2.py','real_machine_harness_contract_v1_4_2.py','runner_cleanliness_contract_v1_4_2.py','security_audit_v1_4_2.py','static_audit_v1_4_2.py'
]
failed=[]
for f in files:
 print(f'\n=== {f} ===',flush=True)
