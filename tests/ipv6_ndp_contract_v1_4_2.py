...
checks={
    ...
    'worker_ipv6_filters_zero_mac':
        "$_.LinkLayerAddress -ne '00-00-00-00-00-00'" in worker,
    'worker_ipv6_rejects_non_unicast_noise':
        'IPv6Any' in worker and 'IPv6Loopback' in worker and 'IsIPv6Multicast' in worker,
    'worker_ipv6_interface_evidence':
        'InterfaceIndex=$interfaceIndex' in worker
        and "Evidence='Windows IPv6 neighbor cache (passive NDP)'" in worker,
    ...
    'worker_no_ipv6_neighbor_mutation':
        all(x not in worker for x in ['New-NetNeighbor','Set-NetNeighbor','New-NetIPAddress','Set-NetIPAddress','Remove-NetNeighbor']),
    'ui_ipv6_phase':
    ...
    'windows_perf_executes_ipv6_contract':
        ...
        and 'FAST synthetic /24 exposes IPv6 neighbor metric' in perf
