...
if /I "%MODE%"=="FULL" (
  ...
  "%PS%" -NoProfile -ExecutionPolicy Bypass -File "%~dp0RF-Network-Tool-RealMachineQualification.ps1" -Mode Full -AllowModuleInstall
) else if /I "%MODE%"=="GUI" (
  echo === RF Network Tool - REAL MACHINE QUALIFICATION [GUI] ===
  "%PS%" -NoProfile -ExecutionPolicy Bypass -File "%~dp0RF-Network-Tool-RealMachineQualification.ps1" -Mode Gui -AllowModuleInstall
) else (
